...
import de.nmichael.efa.core.ExecuteAfterDownload;
...
public class EfaUtil {
  ...
  public static TMJ correctDate(String s,int tt, int mm, int yy) {
    ...
    if (jahr<1980 && !vierstellig) jahr += 100; // nur ursprünglich nicht vierstellige Jahre als größer als 1980 interpretieren
