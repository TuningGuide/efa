...
public class EfaWettFertigFrame extends JDialog implements ActionListener {
  ...
  private void jbInit() throws Exception {
    ...
    wettPanel.setPreferredSize(new Dimension(700, 450));
    infoPanel.setPreferredSize(new Dimension(700, 450));
    ...
    contentPanel.add(jTabbedPane1, BorderLayout.CENTER);
    jTabbedPane1.add(paddedInfoPanel, "Information");
    paddedInfoPanel.add(infoPanel,  new GridBagConstraints(0, 0, GridBagConstraints.REMAINDER, GridBagConstraints.REMAINDER, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(10, 10, 10, 10), 0, 0));
    infoPanel.add(jLabel1,               new GridBagConstraints(0, 0, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    infoPanel.add(jLabel10,                new GridBagConstraints(0, 1, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
    infoPanel.add(dateinameLabel,                 new GridBagConstraints(0, 2, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    infoPanel.add(jLabel2,                new GridBagConstraints(0, 3, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(20, 0, 0, 0), 0, 0));
    infoPanel.add(jLabel6,                new GridBagConstraints(0, 5, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    infoPanel.add(jLabel7,               new GridBagConstraints(0, 6, 8, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    infoPanel.add(jLabel8,              new GridBagConstraints(0, 7, 8, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    infoPanel.add(jLabel9,               new GridBagConstraints(0, 8, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    infoPanel.add(meldegeld1Label,             new GridBagConstraints(0, 9, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
    infoPanel.add(meldegeldLabel,             new GridBagConstraints(0, 10, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    ...
    infoPanel.add(kontoLabel,           new GridBagConstraints(0, 11, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    infoPanel.add(einsendenButton,             new GridBagConstraints(8, 6, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
    infoPanel.add(fahrtenhefte1Label,            new GridBagConstraints(0, 14, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
    infoPanel.add(fahrtenhefte2Label,           new GridBagConstraints(0, 15, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    infoPanel.add(fahrtenhefteAdresseLabel,           new GridBagConstraints(0, 16, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    infoPanel.add(fahrtenhefteScrollPane,          new GridBagConstraints(0, 17, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    infoPanel.add(meldegeld2Label,          new GridBagConstraints(0, 13, 9, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    infoPanel.add(achtung1Label,            new GridBagConstraints(0, 18, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
    infoPanel.add(achtung2Label,        new GridBagConstraints(0, 19, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 10, 0), 0, 0));
    infoPanel.add(saveMeldedateiButton,          new GridBagConstraints(8, 7, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 0, 0), 0, 0));
    fahrtenhefteScrollPane.getViewport().add(fahrtenhefteList, null);
    infoPanel.add(anleitungButton,       new GridBagConstraints(0, 4, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 10, 0), 0, 0));
  }
  ...
  public void actionPerformed(ActionEvent e) {
   ...
   void iniFelder() {
     dateinameLabel.setText(ew.datei);
     ...
     if (meldegeld == null) {
       ...
       if (Daten.vereinsConfig != null) switch(ew.wettId) {
     ...
     if (ew.wettId == WettDefs.DRV_FAHRTENABZEICHEN && papierFahrtenhefte != null && papierFahrtenhefte.size() > 0) {
       if (Daten.vereinsConfig != null) this.fahrtenhefteAdresseLabel.setText(Daten.wettDefs.efw_drv_anschrift);
  ...
  void einsendenButton_actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      f.write("<tr><td>Benutzername:</td><td><tt>"+ew.verein_user+"</tt></td></tr>\n");
  ...
  boolean erstelleMeldeAnleitung(String fname) {
    ...
    try {
      ...
      f.write("<i>"+EfaUtil.getFilenameWithoutPath(ew.datei)+"</i>");
      ...
      if (ew.wettId == WettDefs.DRV_FAHRTENABZEICHEN && papierFahrtenhefte != null && papierFahrtenhefte.size() > 0) {
        ...
        for (int i=0; i<papierFahrtenhefte.size(); i++) f.write("<li>"+(String)papierFahrtenhefte.get(i)+"</li>\n");
        f.write("</ul>\n");
  ...
  void saveMeldedateiButton_actionPerformed(ActionEvent e) {
    ...
    String toFile = dir+EfaUtil.getFilenameWithoutPath(ew.datei);
    if (!(new File(ew.datei)).equals(new File(toFile)) && !EfaUtil.copyFile(ew.datei,toFile)) {
