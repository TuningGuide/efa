...
public class DestinationRecord extends DataRecord {
    ...
    public DestinationRecord(MetaData metaData) {
        super(metaData);
    }
    ...
    public static DestinationRecord createDestinationRecord() {
        return new DestinationRecord(MetaData.getMetaData(Destinations.DATATYPE));
    }

    public static DestinationRecord createDestinationRecord(UUID id) {
        DestinationRecord rec = new DestinationRecord(MetaData.getMetaData(Destinations.DATATYPE));
        rec.setUUID(ID, id);
        return rec;
    }
