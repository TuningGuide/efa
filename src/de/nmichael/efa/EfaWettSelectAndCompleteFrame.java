...
public class EfaWettSelectAndCompleteFrame extends JDialog implements ActionListener {
  ...
  class Item {
    ...
    public int content;
    public Item(EfaWettMeldung m, int content) { this.m = m; this.content = content; }
  }
  ...
  class WarningWindow extends Thread {
    ...
    public void run() {
      try {
        ...
        t.append("Die Verwendung von efa befreit nicht von der Notwendigkeit,\ndie ausgewerteten Daten gr�ndlich zu pr�fen!\n\n"+
                 "Die Auswertung durch efa basiert ausschlie�lich auf den erfa�ten Daten.\nWenn die erfa�ten Daten fehlerhaft sind, so sind es auch die ausgewerteten Daten.\n\n"+
                 "Bitte pr�fe die Daten vor dem Einsenden gr�ndlich auf Korrektheit!");
        JPanel p = new JPanel();
        ...
        try { Thread.sleep(10000); } catch(InterruptedException eee) {}
        w.setVisible(false);
        w.dispose();
        w = null;
      } catch(Exception e) {
  ...
  private void jbInit() throws Exception {
    ...
    jLabelTitel.setText("Bitte markiere alle Teilnehmer, die f�r den Wettbewerb gemeldet werden " +
    "sollen:");
    ...
    gebuehrLabel.setText("Meldegeb�hr");
    ...
    teiln5Label.setText("�quatorpreise: ");
    teiln5Anz.setForeground(Color.black);
    teiln5Anz.setText("0");
    jLabel1.setForeground(Color.red);
    jLabel1.setHorizontalAlignment(SwingConstants.CENTER);
    jLabel1.setHorizontalTextPosition(SwingConstants.CENTER);
    jLabel1.setText("Bitte alle Daten gr�ndlich auf Richtigkeit pr�fen (insb. die rot/orange " +
    "markierten Daten)!");
    teilnehmerInfoPanel.setLayout(gridBagLayout3);
    this.getContentPane().add(contentPane, BorderLayout.CENTER);
    contentPane.add(jPanel1, BorderLayout.SOUTH);
    jPanel1.add(okButton,               new GridBagConstraints(0, 8, 9, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teilnLabel,                new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teilnAnz,                 new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln1Label,                new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln2Label,                new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln3Label,                new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln4Label,                new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    contentPane.add(teilnehmerScrollPane, BorderLayout.CENTER);
    teilnehmerScrollPane.getViewport().add(dataPanel, null);
    contentPane.add(teilnehmerInfoPanel, BorderLayout.NORTH);
    teilnehmerInfoPanel.add(jLabelTitel,   new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5, 0, 0, 0), 0, 0));
    teilnehmerInfoPanel.add(jLabel1,    new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(10, 0, 5, 0), 0, 0));
    jPanel1.add(gebLabel,              new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(teiln1Anz,              new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln2Anz,               new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln3Anz,               new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln4Anz,               new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(meldungenLabel,             new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(gebuehrLabel,               new GridBagConstraints(2, 0, 2, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb1Label,              new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(geb,               new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb1,              new GridBagConstraints(3, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb2,            new GridBagConstraints(3, 3, 2, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(geb2Label,           new GridBagConstraints(2, 3, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestellungenLabel,         new GridBagConstraints(5, 0, 3, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(bestLabel1,        new GridBagConstraints(5, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(best,       new GridBagConstraints(6, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(bestLabel2,       new GridBagConstraints(5, 3, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel3,       new GridBagConstraints(5, 4, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel4,       new GridBagConstraints(5, 5, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel5,       new GridBagConstraints(5, 6, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(best4,      new GridBagConstraints(6, 5, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best3,      new GridBagConstraints(6, 4, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best2,      new GridBagConstraints(6, 3, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best1,      new GridBagConstraints(6, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(bestLabel6,      new GridBagConstraints(5, 7, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(bestLabel,   new GridBagConstraints(5, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 20, 0, 0), 0, 0));
    jPanel1.add(best5,  new GridBagConstraints(6, 6, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(best6,   new GridBagConstraints(6, 7, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln5Label,   new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    jPanel1.add(teiln5Anz,  new GridBagConstraints(1, 7, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
  }
  ...
  void labelFelder(EfaWett ew) {
      ...
      if (ew.wettId == WettDefs.DRV_FAHRTENABZEICHEN) {
        ...
        this.meldungenLabel.setText("Ergebnisse f�r 'Blauer Wimpel'");
    ...
    if (ew.wettId != WettDefs.DRV_FAHRTENABZEICHEN) {
      if (ew.wettId == WettDefs.DRV_WANDERRUDERSTATISTIK) {
        jLabelTitel.setText("Bitte markiere alle Wanderfahrten, die f�r den Wettbewerb gemeldet werden sollen:");
      }
  ...
  void addField(EfaWettMeldung m, int content, int type, String text, int x, int y, int width, int height, int align, Color color, boolean checked) {
    switch(type) {
      case T_LABEL:
        JLabel l = new JLabel();
        l.setText(text);
        if (width>0 && height>0) l.setPreferredSize(new Dimension(width,height));
      ...
      case T_CHECKBOX:
        ...
        c.setText(text);
        if (width>0 && height>0) c.setPreferredSize(new Dimension(width,height));
      ...
      case T_TEXTFIELD:
        ...
        t.setText(text);
        if (width>0 && height>0) t.setPreferredSize(new Dimension(width,height));
        if (color != null) t.setForeground(color);
   ...
   void iniFelder(EfaWett ew) {
     ...
     if (displayGruppe) addField(null,0,T_LABEL,"Gruppe",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayTage) addField(null,0,T_LABEL,"Tage",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayKm) addField(null,0,T_LABEL,"Kilometer",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayTeilnehmer) addField(null,0,T_LABEL,"Teilnehmer",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayAnschrift) addField(null,0,T_LABEL,"Anschrift",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayDRVFahrtenheft) addField(null,0,T_LABEL,"Ges.Abz.",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayDRVFahrtenheft) addField(null,0,T_LABEL,"Ges.Km.",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayAbzeichen) addField(null,0,T_LABEL,"Anstecknadel",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (displayAbzeichen) addField(null,0,T_LABEL,"Stoffabzeichen",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     if (ew.wettId == WettDefs.DRV_FAHRTENABZEICHEN) addField(null,0,T_LABEL,"Bemerkungen",x++,y,0,0,GridBagConstraints.CENTER,null,false);
     ...
     while (m != null) {
       ...
       if (m.drv_fahrtenheft != null && m.drv_fahrtenheft.length() > 0) drvSignatur = new DRVSignatur(m.drv_fahrtenheft);
       ...
       if (displayGruppe) {
         ...
         if (gruppe != null && gruppe.length()>10) {
           ...
           if (gruppe.indexOf("(")>= 0 && gruppe.indexOf(")")<0) gruppe+= ")";
         }
       ...
       // Anschrift (Textfield)
       if (displayAnschrift) {
         if (m.anschrift != null) addField(m,C_ANSCHRIFT,T_TEXTFIELD,m.anschrift,x++,y,200,19,GridBagConstraints.WEST,null,false);
         else x++;
       }
       ...
       if (displayDRVFahrtenheft) {
         ...
         if (drvSignatur != null) {
           ...
           if (drvSignatur.getAnzAbzeichenAB() > 0 && displayAB) s += " ("+drvSignatur.getAnzAbzeichenAB()+")";
         } else {
           s = (m.drv_anzAbzeichen != null ? m.drv_anzAbzeichen : "0");
           if (m.drv_anzAbzeichenAB != null && EfaUtil.string2int(m.drv_anzAbzeichenAB,0) > 0 && displayAB) s += " ("+m.drv_anzAbzeichenAB+")";
         }
         addField(m,0,T_LABEL,s,x++,y,0,0,GridBagConstraints.CENTER,Color.black,false);

         if (drvSignatur != null) {
           s = Integer.toString(drvSignatur.getGesKm());
           if (drvSignatur.getGesKmAB() > 0 && displayAB) s += " ("+drvSignatur.getGesKmAB()+")";
         } else {
           s = (m.drv_gesKm != null ? m.drv_gesKm : "0");
           if (m.drv_gesKmAB != null && EfaUtil.string2int(m.drv_gesKmAB,0) > 0 && displayAB) s += " ("+m.drv_gesKmAB+")";
         }
         addField(m,0,T_LABEL,s,x++,y,0,0,GridBagConstraints.CENTER,Color.black,false);
       }
       ...
       if (displayAbzeichen) {
         if (m.abzeichen != null) {
           ...
           if (m.abzeichen.equals(EfaWettMeldung.ABZEICHEN_ERW_EINF)) { s = "Erw. silber"; }
           if (m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_ERW_GOLD_PRAEFIX)) { s = "Erw. gold"; abzSelected = true; }
           if (m.abzeichen.equals(EfaWettMeldung.ABZEICHEN_JUG_EINF)) { s = "Jug. silber"; }
           if (m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_JUG_GOLD_PRAEFIX)) { s = "Jug. gold"; abzSelected = true; }
           if (m.abzeichen.length()>0 &&
               (drvSignatur == null && EfaUtil.string2int(m.drv_anzAbzeichen,0) == 0) ||
               (drvSignatur != null && drvSignatur.getAnzAbzeichen() == 0) ) abzSelected = true;
           ...
           if (m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_ERW_GOLD_PRAEFIX) ||
               ...
               m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_JUG_GOLD_PRAEFIX)) addField(m,C_BESTELLEN2,T_CHECKBOX,"bestellen",x++,y,0,0,GridBagConstraints.CENTER,null,false);
           else addField(null,0,T_LABEL,"nur bei Gold",x++,y,0,0,GridBagConstraints.CENTER,null,false);
         }
       }
       ...
       if (ew.wettId == WettDefs.DRV_FAHRTENABZEICHEN) {
         ...
         if (m.drv_aequatorpreis != null) s += "; "+m.drv_aequatorpreis+". �quatorpreis";
  ...
  void calculateValues() {
            ...
            switch(ew.wettId) {
              case WettDefs.DRV_FAHRTENABZEICHEN:
                if (item.m.abzeichen != null) {
                  if (item.m.gruppe.startsWith("1") || item.m.gruppe.startsWith("2")) anzMelden1++;
                  if (item.m.gruppe.startsWith("3")) anzMelden2++;

                }
                if (item.m.drv_aequatorpreis != null) anzMelden5++;
                break;
              case WettDefs.LRVBERLIN_SOMMER:
              case WettDefs.LRVBERLIN_WINTER:
                if (item.m.gruppe != null && item.m.gruppe.length()>0) {
                  if (item.m.gruppe.charAt(0) == '1') anzMelden1++;
                  if (item.m.gruppe.charAt(0) == '2') anzMelden2++;
                  if (item.m.gruppe.charAt(0) == '3') anzMelden3++;
                  if (item.m.gruppe.charAt(0) == '4') anzMelden4++;
                }
                break;
            ...
            switch(ew.wettId) {
              case WettDefs.DRV_FAHRTENABZEICHEN:
                if (item.m.abzeichen != null && item.m.abzeichen.length()>=2) {
                  if (item.m.abzeichen.equals(EfaWettMeldung.ABZEICHEN_ERW_EINF)) anzBestellErwEinf++;
                  if (item.m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_ERW_GOLD_PRAEFIX)) anzBestellErwGold[EfaWettMeldung.getAbzeichenGoldIndex(item.m.abzeichen)]++;
                  if (item.m.abzeichen.equals(EfaWettMeldung.ABZEICHEN_JUG_EINF)) anzBestellJugEinf++;
                  if (item.m.abzeichen.startsWith(EfaWettMeldung.ABZEICHEN_JUG_GOLD_PRAEFIX)) anzBestellJugGold[EfaWettMeldung.getAbzeichenGoldIndex(item.m.abzeichen)]++;
                }
                break;
            }
          }
            ...
            switch(ew.wettId) {
              case WettDefs.DRV_FAHRTENABZEICHEN:
                if (item.m.gruppe != null) {
                  if (item.m.gruppe.startsWith("1") || item.m.gruppe.startsWith("2")) anzBestellErwStoff++;
                  if (item.m.gruppe.startsWith("3")) anzBestellJugStoff++;
                }
                break;
            }
          }
    ...
    // Label f�r Teilnehmer-Anzahl (Meldungen)
    ...
    if (ew.wettId == WettDefs.LRVBERLIN_BLAUERWIMPEL) {
      this.teilnAnz.setText(Integer.toString(Daten.fahrtenbuch.getDaten().anzMitglieder));
      this.teiln1Anz.setText(Integer.toString(anzMelden1));
  ...
  void okButton_actionPerformed(ActionEvent e) {
    ...
    // nicht selektierte Meldungen l�schen
    Hashtable gemeldete = getSelectedMeldungen();
    ...
    // Spezialbehandlungen f�r die einzelnen Wettbewerbe
    switch (ew.wettId) {
      case WettDefs.DRV_FAHRTENABZEICHEN:
        // Bestellungen in Meldedatei vermerken
        ew.drv_nadel_erw_silber = Integer.toString(anzBestellErwEinf);
        ew.drv_nadel_erw_gold   = EfaUtil.arr2KommaList(anzBestellErwGold,1);
        ew.drv_nadel_jug_silber = Integer.toString(anzBestellJugEinf);
        ew.drv_nadel_jug_gold   = EfaUtil.arr2KommaList(anzBestellJugGold,1);
        ew.drv_stoff_erw        = Integer.toString(anzBestellErwStoff);
        ew.drv_stoff_jug        = Integer.toString(anzBestellJugStoff);
        break;
      case WettDefs.LRVBERLIN_SOMMER:
        // Adressen in Meldedatei vermerken und ggf. in Adre�datei speichern
        Object[] textfKeys = this.textfields.keySet().toArray();
        ...
        for (int i=0; i<textfKeys.length; i++) {
          ...
          if (gemeldete.get(item.m) != null) {
            ...
            if (Daten.adressen != null) {
              DatenFelder d = Daten.adressen.getExactComplete(item.m.vorname+" "+item.m.nachname);
              if (d == null) {
                Daten.adressen.add(item.m.vorname+" "+item.m.nachname+"|"+item.m.anschrift);
                addrChanged = true;
              } else {
                if (!item.m.anschrift.equals(d.get(Adressen.ADRESSE))) {
                  Daten.adressen.delete(item.m.vorname+" "+item.m.nachname);
                  Daten.adressen.add(item.m.vorname+" "+item.m.nachname+"|"+item.m.anschrift);
                  addrChanged = true;
                }
              }
        ...
        if (addrChanged && Daten.adressen != null) {
          if (Dialog.yesNoDialog("Adressen speichern",
                                 "Sollen die �nderungen an den Teilnehmer-Adressen in efa gespeichert werden?\n"+
                                 "(Wenn die Adressen gespeichert werden, m�ssen sie bei der n�chsten Meldung\n"+
                                 "nicht erneut eingegeben werden.)") == Dialog.YES) {
            Daten.adressen.writeFile();
          } else {
            Daten.adressen.readFile();
          }
        }
        break;
      case WettDefs.LRVBERLIN_WINTER:
      ...
      case WettDefs.LRVBERLIN_BLAUERWIMPEL:
        ...
        ew.verein_mitglieder = teilnAnz.getText();
        ew.wimpel_mitglieder = teiln1Anz.getText();
        ew.wimpel_km = teiln2Anz.getText();
        ew.wimpel_schnitt = teiln3Anz.getText();
        break;
